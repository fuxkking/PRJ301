...
<body>
    <div class="profile-main" style="justify-content:center;">
        <div class="profile-card" style="min-width:400px;max-width:600px;width:100%;margin:auto;">
            <form class="profile-form" action="${pageContext.request.contextPath}/userUpdate" method="post">
                <img class="profile-avatar" src="${sessionScope.account.image}" alt="Avatar">
                <label>Username</label>
                <input type="text" name="username" value="${sessionScope.account.username}" disabled>
                <label>Email</label>
                <input type="email" name="email" value="${sessionScope.account.email}" disabled>
                <label>Phone</label>
                <input type="text" name="phone" value="${sessionScope.account.phone}" disabled>
                <label>Avatar URL</label>
                <input type="text" name="image" value="${sessionScope.account.image}">
